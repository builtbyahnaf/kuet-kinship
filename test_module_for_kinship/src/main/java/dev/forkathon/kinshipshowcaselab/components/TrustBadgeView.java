...
public class TrustBadgeView extends TextView {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public TrustBadgeView(Context context) { super(context); initialize(); }
    public TrustBadgeView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public TrustBadgeView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "TrustBadgeView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
