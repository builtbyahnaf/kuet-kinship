...
public class TimelineNodeView extends View {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public TimelineNodeView(Context context) { super(context); initialize(); }
    public TimelineNodeView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public TimelineNodeView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "TimelineNodeView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
