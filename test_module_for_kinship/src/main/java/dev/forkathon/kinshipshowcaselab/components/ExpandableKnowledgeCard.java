...
public class ExpandableKnowledgeCard extends LinearLayout {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public ExpandableKnowledgeCard(Context context) { super(context); initialize(); }
    public ExpandableKnowledgeCard(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public ExpandableKnowledgeCard(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "ExpandableKnowledgeCard[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
