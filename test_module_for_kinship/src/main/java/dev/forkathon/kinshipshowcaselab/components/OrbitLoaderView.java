...
public class OrbitLoaderView extends View {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public OrbitLoaderView(Context context) { super(context); initialize(); }
    public OrbitLoaderView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public OrbitLoaderView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "OrbitLoaderView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
