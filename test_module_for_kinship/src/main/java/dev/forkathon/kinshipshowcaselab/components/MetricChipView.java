...
public class MetricChipView extends TextView {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public MetricChipView(Context context) { super(context); initialize(); }
    public MetricChipView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public MetricChipView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "MetricChipView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
