...
public class GlassPanel extends FrameLayout {
    ...
    public GlassPanel(Context context) { super(context); initialize(); }
    public GlassPanel(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public GlassPanel(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "GlassPanel[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
