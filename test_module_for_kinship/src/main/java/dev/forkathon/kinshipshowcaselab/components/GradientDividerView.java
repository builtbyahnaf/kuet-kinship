...
public class GradientDividerView extends View {
    ...
    public GradientDividerView(Context context) { super(context); initialize(); }
    public GradientDividerView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public GradientDividerView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "GradientDividerView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
