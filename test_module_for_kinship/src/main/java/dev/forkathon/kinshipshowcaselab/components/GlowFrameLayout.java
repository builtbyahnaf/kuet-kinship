...
public class GlowFrameLayout extends FrameLayout {
    ...
    public GlowFrameLayout(Context context) { super(context); initialize(); }
    public GlowFrameLayout(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public GlowFrameLayout(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "GlowFrameLayout[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
