...
public class ProgressRingView extends View {
    ...
    public ProgressRingView(Context context) { super(context); initialize(); }
    public ProgressRingView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public ProgressRingView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "ProgressRingView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
