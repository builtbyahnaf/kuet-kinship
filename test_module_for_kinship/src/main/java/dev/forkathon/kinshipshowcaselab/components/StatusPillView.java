...
public class StatusPillView extends TextView {
    private final Paint paint = new Paint(Paint.ANTI_ALIAS_FLAG);
    private long createdAt = System.currentTimeMillis();
    private boolean active = true;

    public StatusPillView(Context context) { super(context); initialize(); }
    public StatusPillView(Context context, AttributeSet attrs) { super(context, attrs); initialize(); }
    public StatusPillView(Context context, AttributeSet attrs, int style) { super(context, attrs, style); initialize(); }
    ...
    public String componentInfo() {
        return "StatusPillView[active=" + active + ", ageMs=" + getAgeMs() + "]";
    }
}
